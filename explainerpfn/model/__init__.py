...
from explainerpfn.model.config import ModelConfig, ArchitectureConfig
from explainerpfn.model.transformer import PerFeatureTransformer
...
def get_y_encoder(
    *,
    ...
    # TODO: check how target transformations can be handled properly for Shapley values.
