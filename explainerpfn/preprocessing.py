# Adapted from the TabPFN repository.
...
@dataclass
class ExplainerDatasetConfig(BaseDatasetConfig):
    """Explainer Dataset + Model Configuration class."""
...
# TODO: Make this frozen (frozen=True)
@dataclass
class EnsembleConfig:
    ...
    # TODO: redesign method
    @classmethod
    def generate_for_explainability(
        cls,
        *,
        n: int,
...
@dataclass
class ExplainerEnsembleConfig(EnsembleConfig):
...
class DatasetCollectionWithPreprocessing(Dataset):
    ...
    def __getitem__(self, index):  # noqa: C901, PLR0912
        ...
        # TODO: Check if this is the right way to handle the target (e.g., for
        # categorical features this should be handled differently)
        # --------------------------------------------------------------------
